                                    ...
                                    <div className="card-body p-4">
                                        ...
                                        <div className="form-outline mb-2">
                                            ...
                                            <div className="form-outline mb-2">
                                                ...
                                                <input type="password" name='password' onChange={formik.handleChange} className="form-control form-control-sm" />
                                                {formik.errors.password && formik.touched.password && (<p style={{ color: 'red' }}>{formik.errors.password}</p>)}
                                            </div>
                                           
                                            <div className="form-outline mb-2">
                                                <label className="form-label" >Name:</label>
                                                <input type="text" name='name' onChange={formik.handleChange} className="form-control form-control-sm" />
                                                {formik.errors.name && formik.touched.name && (<p style={{ color: 'red' }}>{formik.errors.name}</p>)}
                                            </div>
                                           
                                            <div className="form-outline mb-2">
                                                <label className="form-label" >PhoneNumber:</label>
                                                <input type="number" name='phoneNumber' onChange={formik.handleChange} className="form-control form-control-sm" />
